# Election System: Vocdoni

Created by: Aditya Dahiya
Created time: May 28, 2023 7:56 PM
...
> This document describes the primary web3 solution that the Election Committee (EC) may use for end-season elections.
> 
